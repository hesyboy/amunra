                    ...
                    <div class="flex flex-col gap-8  justify-between h-full ">
                        ...
                        <div class="flex flex-col gap-8 items-center justify-between group">
                            <div class="bg-yellow-600 p-3 rounded-full">
                                ...
                                ">
                                    <div class="swiper-wrapper">
                                      ...
                                      <div class="swiper-slide">
                                        <img src="{{asset('/images/slide2.png')}}" class="w-[300px]" />
                                      </div>
                                      <div class="swiper-slide">
                                        <img src="{{asset('/images/slide3.png')}}" class="w-[300px]" />
                                      </div>
                                      <div class="swiper-slide">
                                        <img src="{{asset('/images/slide4.png')}}" class="w-[300px]" />
                                      </div>
                                    </div>
                            ...
                            <div class="flex flex-col gap-1 items-center justify-center">
                                <h1 class="text-7xl text-zinc-300 tracking-[6px]">AMUNRA NFT</h1>
                                <p class="text-5xl text-yellow-600 font1 tracking-[4px]">Play To Earn</p>
                            </div>
                        </div>

                        <div class="flex flex-col gap-5 justify-center items-center">
                            <div class=" text-xl text-gray-400 mt-14">Follow Us</div>
                            <div class="flex gap-8">
                                ...
                                <a class="flex flex-col justify-center items-center text-gray-300 hover:text-yellow-600
                                transition-all duration-300 hover:scale-95 " href="">
                                    <ion-icon name="logo-discord" class="text-5xl "></ion-icon>
                                ...
                                <a class="flex flex-col justify-center items-center text-gray-300 hover:text-yellow-600
                                transition-all duration-300 hover:scale-95 " href="">
                                    <ion-icon name="navigate-circle" class="text-5xl "></ion-icon>
                    ...
                    <div class="flex flex-col gap-7 items-center">
                        <div class="flex flex-col items-center gap-8">
                            <div class="flex flex-col items-center ">
                                <img src="{{asset('/images/logo2.png')}}" class="w-[300px]" />
                                <h1 class="text-7xl text-gray-300 font1 tracking-[6px]"> World Of Amunra</h1>
                            </div>

                            <p class="text-xl text-gray-400 tracking-[3px] leading-10 text-center">Amunra is old-school fighting game in metaverse and it has 12 master characters
                                 of fighters . Project aiming to restore the amunra civilization in the metaverse and to protect cultural heritage
                                  and environments all around the world. First of all we are working with some  absolutely intelligence artists to
                                  bring you stunning 2D and 3D collection. Our upcoming 2D collection consists of another eleven 10000 nfts generated
                                   from 650 all hand drawn unique traits . Our 3D collection will come before gaming launch .we believe that our game
                                    ...
                                    5 nft developers , 2 gaming developers and 3 moderators.</p>
                            <div>
                ...
                <div class="">
                    ...
                    <div class="flex flex-col gap-7 items-center">
                        <div class="flex flex-col items-center gap-1">
                            <div class="flex flex-col items-center ">
                                <img src="{{asset('/images/logo1.png')}}" class="w-[200px]" />
